...
public class dim2array2 {
    public static void main(String[] args) {
        ...
        try (// 5팀이 게임을 진행하는데 각 팀의 내부 사정으로 게임에 참여 못하는 팀이 생김.
                // 그래서 팀의 전체 평균으로 평가하며, 이를 반영하여 배열 구성(가변 배열) 
        Scanner sc = new Scanner(System.in)) {
            int[][] team_score = new int[5][];
            team_score[0] = new int[7];
            team_score[1] = new int[5];
            team_score[2] = new int[3];
            team_score[3] = new int[4];
            team_score[4] = new int[7];
             // 7게임 모두 참여
             // 5게임 참여
             // 3게임 참여
             // 4게임 참여
